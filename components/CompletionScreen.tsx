...
const CompletionScreen: React.FC<CompletionScreenProps> = ({ onRestart }) => {
  return (
    <div className="text-center bg-white dark:bg-slate-800 rounded-2xl shadow-lg p-8 sm:p-12 animate-fade-in">
      ...
      <h2 className="text-3xl sm:text-4xl font-bold mb-3 text-slate-800 dark:text-slate-100">온보딩 프로그램을 완수했습니다!</h2>
      <p className="text-slate-600 dark:text-slate-400 mb-8 text-lg">
        축하합니다! 시나리오 기반 학습을 통해 글로벌 인재의 핵심 역량을 탐색했습니다. 이 경험이 당신의 성공적인 커리어 여정에 훌륭한 첫걸음이 되기를 바랍니다.
      </p>
      <button
        onClick={onRestart}
